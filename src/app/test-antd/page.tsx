    ...
    return (
        <div className="p-8 space-y-8 max-w-6xl mx-auto">
            ...
            <section className="space-y-4">
                ...
                <antdRegistry.Text element={el('Text', { variant: 'h3', children: 'Heading 3' }, 'text-h3')} />
            ...
            <section className="space-y-4">
                ...
                <div className="flex gap-4 items-center">
                    <antdRegistry.Avatar element={el('Avatar', { fallback: 'JD', alt: 'John Doe' }, 'avatar-1')} />
                    <antdRegistry.Icon element={el('Icon', { name: 'User', size: 24 }, 'icon-1')} />
                    <antdRegistry.Icon element={el('Icon', { name: 'Settings', size: 24 }, 'icon-2')} />
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <antdRegistry.Alert element={el('Alert', { variant: 'success', title: 'Success', description: 'Completed!' }, 'alert-2')} />
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 max-w-2xl">
                    <antdRegistry.Input element={el('Input', { label: 'Email', name: 'email', placeholder: 'Enter email' }, 'input-1')} />
                    <antdRegistry.Select element={el('Select', { label: 'Country', name: 'country', options: [{ label: 'US', value: 'us' }, { label: 'UK', value: 'uk' }] }, 'select-1')} />
                    <antdRegistry.Checkbox element={el('Checkbox', { label: 'Accept terms', name: 'terms' }, 'checkbox-1')} />
                    <antdRegistry.Switch element={el('Switch', { label: 'Notifications', name: 'notif' }, 'switch-1')} />
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <antdRegistry.Chart element={el('Chart', { type: 'bar', data: chartData, categories: ['sales', 'revenue'], index: 'month' }, 'chart-1')} />
                    <antdRegistry.Chart element={el('Chart', { type: 'line', data: chartData, categories: ['sales', 'revenue'], index: 'month' }, 'chart-2')} />
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <antdRegistry.Tabs element={el('Tabs', {
                    items: [
