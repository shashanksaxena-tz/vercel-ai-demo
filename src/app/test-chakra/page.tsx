...
// We can extend the registry here for test-specific components if needed
const testRegistry = {
  ...chakraRegistry,
...
const elements = [
  ...
  // Title
  { key: 'title', type: 'Text', props: { variant: 'h2', children: 'Chakra UI Registry Test' }, parentKey: 'stack1' },
  ...
  // Alert
  { key: 'alert1', type: 'Alert', props: { title: 'Success', description: 'Chakra components rendered successfully.', variant: 'default', icon: 'check-circle' }, parentKey: 'stack1' }
];
