...
export const Post = ({ element, children, onAction }: ComponentRenderProps) => {
  const {
    id,
    author,
    avatar,
  ...
  return (
    <div
      className={cn('border rounded-lg bg-card p-4')}
    ...
    >
      ...
      {content && <p className="mb-3 whitespace-pre-wrap">{content as string}</p>}
